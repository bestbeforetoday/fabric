...
type QueryProvider struct {
	TransactionStatusStub        func(string, string) (*commit.Status, error)
...
func (fake *QueryProvider) TransactionStatus(arg1 string, arg2 string) (*commit.Status, error) {
...
func (fake *QueryProvider) TransactionStatusCalls(stub func(string, string) (*commit.Status, error)) {
	fake.transactionStatusMutex.Lock()
...
func (fake *QueryProvider) TransactionStatusReturns(result1 *commit.Status, result2 error) {
	fake.transactionStatusMutex.Lock()
	defer fake.transactionStatusMutex.Unlock()
...
func (fake *QueryProvider) TransactionStatusReturnsOnCall(i int, result1 *commit.Status, result2 error) {
	fake.transactionStatusMutex.Lock()
	defer fake.transactionStatusMutex.Unlock()
	fake.TransactionStatusStub = nil
